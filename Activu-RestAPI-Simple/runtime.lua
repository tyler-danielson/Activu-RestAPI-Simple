...
--[[
for key,object in ipairs(BtnAddSource) do
  object.EventHandler = function() AddCustomSource(key) end
end

for key,object in ipairs(BtnRemoveSource) do
  object.EventHandler = function() RemoveCustomSource(key) end
end
]]--
